export async function githubProfile(username, url) {
  ...
  return new Promise(async (resolve) => {
    ...
    try {
      ...
      avatarEl.alt = `${data.login} GitHub profile picture`;
  
      const footerLink = document.querySelector("footer a");
      if (footerLink) footerLink.href = data.html_url;
